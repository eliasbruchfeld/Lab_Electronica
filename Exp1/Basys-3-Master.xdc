...
##USB-RS232 Interface
#set_property PACKAGE_PIN B18 [get_ports RsRx]		              //Descomentasr para mandar por pc				
	#set_property IOSTANDARD LVCMOS33 [get_ports RsRx]             //Descomentasr para mandar por pc	
